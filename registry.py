...
MODELS = {
    ...
    "qwen-image-2.1": {
        ...
        "deps": ["vae_qwen21", "qwen3vl_8b", "mmproj_qwen3vl_8b"],
        "supports_neg": True,
        "needs_token": False,
        "license": "Qwen Research (usage non-commercial uniquement)",
        "hf_url": "https://huggingface.co/leejet/Qwen-Image-2.1-GGUF",
        "vram_min_gb": 12,
        "desc": "Version 2.1 amelioree. Generation + edition d'images, transparence. Licence non-commercial. Pour l'edition: telecharger mmproj.",
